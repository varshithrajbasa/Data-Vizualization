...
try
{
ChartUtilities.saveChartAsJPEG(new File("F:/project/MINI_PROJECT/Online1/WebContent/images/markstimegraph.jpg"), chart, 400, usercount*150);
}
catch (IOException e)
{
...
<html>
    ...
    <body style="background-color: #f3f3f3">
        ...
        <IMG SRC="F:/project/MINI_PROJECT/Online1/WebContent/images/markstimegraph.jpg" WIDTH="700" HEIGHT="<%=(usercount*200) %>"  BORDER="0" USEMAP="#chart">
    </body>
</html>