...
try
{
ChartUtilities.saveChartAsJPEG(new File("F:/project/MINI_PROJECT/Online1/WebContent/images/linegraph.jpg"), chart, 400, 300);
}
catch (IOException e)
{
...
<html>
    ...
    <body style="background-color: #f3f3f3">
        ...
        <IMG SRC="F:/project/MINI_PROJECT/Online1/WebContent/images/linegraph.jpg" WIDTH="600" HEIGHT="400"  BORDER="0" USEMAP="#chart">
    </body>
</html>