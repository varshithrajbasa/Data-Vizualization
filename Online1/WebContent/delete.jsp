...
%>
<P align=center><U><B>Delete Questions in subject '<%=subject%>'</B></U></P>
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/etest","root","");
	...
	while(rs.next()){
		...
		<td><%=an%></td>
		<td><%=level%></td>
		<td><a href='delproc.jsp?qno=<%=qno%>&&subject=<%=subject%>&&level=<%=level%>'>delete</a></td>
		</tr>
		<%
	}/* of while*/
ps.close();
...
<P>&nbsp;</P>
<a href ="DeleteQuestions0.jsp">go to choose subject</a>
